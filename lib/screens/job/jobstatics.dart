...
class JobStaticsScreen extends StatefulWidget {
  const JobStaticsScreen({super.key});

  @override
  State<JobStaticsScreen> createState() => _JobStaticsScreenState();
}

class _JobStaticsScreenState extends State<JobStaticsScreen> {
                ...
                IntrinsicHeight(
                  child: Row(
                    ...
                    children: [
                      ...
                      const AppImage("assets/images/calendar.svg")
                    ],
                  ),
                ),
                Align(
